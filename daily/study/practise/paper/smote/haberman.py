...
# germandata = numpy.loadtxt(open("H:\Datamining\UCI\haberman\SMOTE_habermanData.csv", "rb"), delimiter=","
#                            , skiprows=0)
# train = germandata[:330]    # train
# test = germandata[330:]     # test
# germandata = numpy.loadtxt(open("H:\Datamining\UCI\haberman\habermanData.csv", "rb"), delimiter=","
#                            , skiprows=0)
# train = germandata[75:]    # train
# test = germandata[:75]     # test

germandata = numpy.loadtxt(open("H:\Datamining\UCI\haberman\ESMOTE_habermanData.csv", "rb"), delimiter=","
                           , skiprows=0)
train = germandata[:363]    # train
test = germandata[363:]     # test
