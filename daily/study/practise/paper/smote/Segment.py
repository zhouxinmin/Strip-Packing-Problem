...
# germandata = numpy.loadtxt(open("H:/Datamining/UCI/Segment/SMOTE_segmentation.csv", "rb"), delimiter=","
#                            , skiprows=0)
# train = germandata[:2924]    # train
# test = germandata[2924:]     # test

# germandata = numpy.loadtxt(open("H:/Datamining/UCI/Segment/segmentation.csv", "rb"), delimiter=","
#                            , skiprows=0)
