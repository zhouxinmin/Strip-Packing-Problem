...
# germandata = numpy.loadtxt(open("H:/Datamining/UCI/Balance/SMOTE_balance-scale.csv", "rb"), delimiter=","
#                            , skiprows=0)
# train = germandata[:709]    # train
# test = germandata[709:]     # test

# germandata = numpy.loadtxt(open("H:/Datamining/UCI/Balance/balance-scale - transfer.csv", "rb"), delimiter=","
#                            , skiprows=0)
# train = germandata[156:]    # train
# test = germandata[:156]     # test

germandata = numpy.loadtxt(open("H:/Datamining/UCI/Balance/ESMOTE_balance-scale.csv", "rb"), delimiter=","
                           , skiprows=0)
train = germandata[:1057]    # train
test = germandata[1057:]     # test
