...
# germandata = numpy.loadtxt(open("H:/Datamining/UCI/ionosphere/SMOTE_ionosphereData.csv", "rb"), delimiter=","
#                            , skiprows=0)
# train = germandata[:368]    # train
# test = germandata[368:]     # test
# germandata = numpy.loadtxt(open("H:/Datamining/UCI/ionosphere/ionosphereData.csv", "rb"), delimiter=","
#                            , skiprows=0)
# train = germandata[82:]    # train
# test = germandata[:82]     # test

germandata = numpy.loadtxt(open("H:/Datamining/UCI/ionosphere/ESMOTE_ionosphereData.csv", "rb"), delimiter=","
                           , skiprows=0)
train = germandata[:439]    # train
test = germandata[439:]     # test
