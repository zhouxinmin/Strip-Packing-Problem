...
# germandata = numpy.loadtxt(open("H:/Datamining/UCI/Blood/smote_transfusionData.csv", "rb"), delimiter=","
#                            , skiprows=0)
# train = germandata[:918]    # train
# test = germandata[918:]     # test

germandata = numpy.loadtxt(open("H:/Datamining/UCI/Blood/transfusionData.csv", "rb"), delimiter=","
                           , skiprows=0)
train = germandata[187:]    # train
test = germandata[:187]     # test

# germandata = numpy.loadtxt(open("H:/Datamining/UCI/Blood/esmote_transfusionData.csv", "rb"), delimiter=","
#                            , skiprows=0)
# train = germandata[:1081]    # train
# test = germandata[1081:]     # test
