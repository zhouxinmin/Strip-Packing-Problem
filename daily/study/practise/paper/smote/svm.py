...
germandata = numpy.loadtxt(open("H:/Datamining/UCI/German Credit Dataset/esmote_Germandata.csv", "rb"), delimiter=","
                           , skiprows=0)
train = germandata[:1196]    # train
test = germandata[1196:]     # test
# germandata = numpy.loadtxt(open("H:/Datamining/UCI/German Credit Dataset/Germandatanumeric.csv", "rb"), delimiter=","
#                            , skiprows=0)
# train = germandata[:750]    # train
# test = germandata[750:]     # test

# germandata = numpy.loadtxt(open("H:/Datamining/UCI/German Credit Dataset/smote_German_data.csv", "rb"), delimiter=","
#                            , skiprows=0)
# train = germandata[:1054]    # train
# test = germandata[1054:]     # test
