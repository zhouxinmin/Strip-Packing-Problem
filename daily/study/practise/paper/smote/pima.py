...
# germandata = numpy.loadtxt(open("H:/Datamining/UCI/Pima/smote_pima_data.csv", "rb"), delimiter=","
#                            , skiprows=0)
# train = germandata[:755]    # train
# test = germandata[755:]     # test
# germandata = numpy.loadtxt(open("H:/Datamining/UCI/Pima/pimaData.csv", "rb"), delimiter=","
#                            , skiprows=0)
# train = germandata[:576]    # train
# test = germandata[576:]     # test

germandata = numpy.loadtxt(open("H:/Datamining/UCI/Pima/esmote_pimaData.csv", "rb"), delimiter=","
                           , skiprows=0)
train = germandata[:774]    # train
test = germandata[774:]     # test
