...
# germandata = numpy.loadtxt(open("H:/Datamining/UCI/Ecoli/SMOTE_ecoli.csv", "rb"), delimiter=","
#                            , skiprows=0)
# train = germandata[:427]    # train
# test = germandata[427:]     # test

# germandata = numpy.loadtxt(open("H:/Datamining/UCI/Ecoli/glass.csv", "rb"), delimiter=","
#                            , skiprows=0)
# train = germandata[:252]    # train
# test = germandata[252:]     # test

germandata = numpy.loadtxt(open("H:/Datamining/UCI/Ecoli/ESMOTE_ecoli.csv", "rb"), delimiter=","
                           , skiprows=0)
train = germandata[:442]    # train
test = germandata[526:]     # test
