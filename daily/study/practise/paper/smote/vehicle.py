...
germandata = numpy.loadtxt(open("H:/Datamining/UCI/vehicle/SMOTE_vehicle.csv", "rb"), delimiter=","
                           , skiprows=0)
train = germandata[:1294]    # train
test = germandata[1294:]     # test

# germandata = numpy.loadtxt(open("H:/Datamining/UCI/vehicle/vehicle.csv", "rb"), delimiter=","
#                            , skiprows=0)
# train = germandata[:634]    # train
# test = germandata[634:]     # test

# germandata = numpy.loadtxt(open("H:/Datamining/UCI/Segment/ESMOTE_segmentation.csv", "rb"), delimiter=","
#                            , skiprows=0)
# train = germandata[:3082]    # train
# test = germandata[3082:]     # test
